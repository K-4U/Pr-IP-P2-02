...
Private Sub btnApp_Click()
    DoCmd.OpenForm "frmApplicatieBeheerder", , , , , acDialog
End Sub

Private Sub btnCategory_Click()
    DoCmd.OpenForm "frmRubriekBeheerder", , , , , acDialog
End Sub
...
Private Sub btnProducts_Click()
    DoCmd.OpenForm "frmProductBeheerder", , , , , acDialog
End Sub
