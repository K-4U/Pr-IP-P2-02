        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT users.username AS Gebruikersnaam FROM users WHERE users.username NOT IN ("
                        "SELECT username FROM ranks); "
                    GridlineColor =10921638
...
Private Sub Form_Load()
     ...
     Me.chkCustomerService.Value = False
