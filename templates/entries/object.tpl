<div class="well col-md-4 col-xs-12 col-sm-12 object clickable" data-link="{baseurl url="Kavel/Item/`$object.id`"}">
    <img class="col-md-6 col-xs-6 col-sm-6" src="{$object.image}" />
