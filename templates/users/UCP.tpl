...
{if $updateComplete}
    <div class=" alert alert-success alert-dismissible col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
        ...
        Account gegevens zijn aangepast.
    </div>
{/if}
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <input type="text" id="questionAnswer" name="questionAnswer" class="form-control" placeholder="Vul hier een nieuw antwoord in."><br>
                            </div>
                        </div>

                        <button class="btn btn-cta" type="submit" name="submit">Opslaan</button>
                    </div>
                </div>
            </div>
        </form>
